...
interface KeyValueListProps<TData extends Record<string, unknown>> {
  title?: string;
  data: TData;
  keys?: KeyValueType[];
}

function KeyValueList<TData extends Record<string, unknown>>({
  title,
  data,
  keys,
}: Readonly<KeyValueListProps<TData>>) {
  return (
